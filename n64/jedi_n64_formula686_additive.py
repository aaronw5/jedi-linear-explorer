"""JEDI-linear jet tagger, 64 particles, 3 features: the tuned formula (start): each class score as ONE plain sum of the formula's terms of the jet quantities.
...
Test set (50,000 jets): accuracy 81.50% (the formula: 81.46%); same class as the formula for 97.49% of jets.  585 terms per score.
"""
