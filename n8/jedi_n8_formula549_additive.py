"""JEDI-linear jet tagger, 8 particles, 3 features: the simplest formula at the network's accuracy (from the 931-term tuned formula): each class score as ONE plain sum of the formula's terms of the jet quantities.
...
Test set (50,000 jets): accuracy 65.60% (the formula: 65.80%); same class as the formula for 94.64% of jets.  534 terms per score.
"""
