"""JEDI-linear jet tagger, 8 particles, 3 features: the simplest formula at the network's accuracy (from the 931-term tuned formula), as if-statements, with each class score (logit) written out as a formula.
